package local.ateng.java.storage.utils;
...
public class MybatisFlexGenerator {
    // 根包名
    private static final String BasePackage = "local.ateng.java.storage";
    ...
    public static void main(String[] args) {
        ...
        dataSource.setUrl("jdbc:mysql://192.168.1.10:35725/kongyu_file");
