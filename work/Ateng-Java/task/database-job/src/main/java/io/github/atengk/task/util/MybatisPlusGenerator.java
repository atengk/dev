...
public class MybatisPlusGenerator {
    // 根包名
    private static final String BasePackage = "io.github.atengk.task";
    ...
    private static final List<String> GenerateTable = Arrays.asList(
            "task_job", "task_job_log"
    );

    public static void main(String[] args) {
        PathEntity path = getPath();
        FastAutoGenerator.create(System.getenv("SPRING_DATASOURCE_URL"), System.getenv("SPRING_DATASOURCE_USERNAME"), System.getenv("SPRING_DATASOURCE_PASSWORD"))
